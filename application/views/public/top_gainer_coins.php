...
<!-- Data Table  -->
<div class="container">
        <div class="alert alert-success" role="alert">Discover crypto coins (from top 250) with volume(24h) > US$50,000 have gained the most based on price movements in the last 24 hours?</div>
  <div class="row justify-content-center">
    <div class="col-md-12 text-left">
      <div class="py-2">
